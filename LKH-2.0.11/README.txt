...
INSTRUCTIONS FOR INSTALLATION: (Version 2.0.11 - June 2025)
-----------------------------

The software is available in gzipped tar format:

	LKH-2.0.11.tgz	(approximately 1.5 MB)

Download the software and execute the following UNIX commands:

  	tar xvfz LKH-2.0.11.tgz
   	cd LKH-2.0.11
	make
...
Distances may be scaled

New parameter keyword:
    SCALE = <integer>
    Distances are multiplied by this factor.
...
New edge weight types:
    EXACT_2D
    Equivalent to EUC_2D with SCALE = 1000.

    EXACT_3D
    Equivalent to EUC_3D with SCALE = 1000.
